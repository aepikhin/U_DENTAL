    ...
    <div>
        ...
        <table class="content">
            <tr>
                ...
                <td colspan="2"><asp:TextBox ID="TextDni" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2"><asp:DropDownList ID="DropDownListEspecialidad" runat="server" OnSelectedIndexChanged="DropDownListEspecialidad_SelectedIndexChanged" DataSourceID="ObjectDataSource1" DataTextField="Nombre" DataValueField="Nombre">
                    </asp:DropDownList>
